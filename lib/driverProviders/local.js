...
LocalDriverProvider.prototype.setupEnv = function() {
  ...
  // load the firefoxDriver arguments
  Object.keys(this.config_.firefoxDriverArgs).forEach(function(arg) {
    this.config_.seleniumArgs.push('-Dwebdriver.firefox.' + opt + '=' + this.config_.firefoxDriverArgs);
  });
